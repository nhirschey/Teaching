...
```
Real: 00:00:00.018, CPU: 00:00:00.015, GC gen0: 0, gen1: 0, gen2: 0
...
```
Real: 00:00:00.018, CPU: 00:00:00.031, GC gen0: 0, gen1: 0, gen2: 0
...
```
Real: 00:00:00.020, CPU: 00:00:00.031, GC gen0: 0, gen1: 0, gen2: 0
val it: int option = None
```
...
```
input.fsx (1,1)-(7,11) interactive warning Accessing the internal type, method or field 'Day@' from a previous evaluation in F# Interactive is deprecated and may cause subsequent access errors. To enable the legacy generation of a single dynamic assembly that can access internals, use the '--multiemit-' option.
...
I did not find c
I found 7
Real: 00:00:00.025, CPU: 00:00:00.031, GC gen0: 1, gen1: 0, gen2: 0
val it: unit = ()
```
...
```
input.fsx (1,1)-(46,44) interactive warning Accessing the internal type, method or field 'Time@' from a previous evaluation in F# Interactive is deprecated and may cause subsequent access errors. To enable the legacy generation of a single dynamic assembly that can access internals, use the '--multiemit-' option.
input.fsx (1,1)-(46,44) interactive warning Accessing the internal type, method or field 'Price@' from a previous evaluation in F# Interactive is deprecated and may cause subsequent access errors. To enable the legacy generation of a single dynamic assembly that can access internals, use the '--multiemit-' option.
...
```
input.fsx (1,1)-(17,42) interactive warning Accessing the internal type, method or field 'Time@' from a previous evaluation in F# Interactive is deprecated and may cause subsequent access errors. To enable the legacy generation of a single dynamic assembly that can access internals, use the '--multiemit-' option.
input.fsx (1,1)-(17,42) interactive warning Accessing the internal type, method or field 'Price@' from a previous evaluation in F# Interactive is deprecated and may cause subsequent access errors. To enable the legacy generation of a single dynamic assembly that can access internals, use the '--multiemit-' option.
Real: 00:00:00.000, CPU: 00:00:00.000, GC gen0: 0, gen1: 0, gen2: 0
...
```
input.fsx (1,1)-(27,52) interactive warning Accessing the internal type, method or field 'Time@' from a previous evaluation in F# Interactive is deprecated and may cause subsequent access errors. To enable the legacy generation of a single dynamic assembly that can access internals, use the '--multiemit-' option.
input.fsx (1,1)-(27,52) interactive warning Accessing the internal type, method or field 'Price@' from a previous evaluation in F# Interactive is deprecated and may cause subsequent access errors. To enable the legacy generation of a single dynamic assembly that can access internals, use the '--multiemit-' option.
Real: 00:00:00.045, CPU: 00:00:00.046, GC gen0: 1, gen1: 0, gen2: 0
...
```
input.fsx (1,1)-(47,45) interactive warning Accessing the internal type, method or field 'Time@' from a previous evaluation in F# Interactive is deprecated and may cause subsequent access errors. To enable the legacy generation of a single dynamic assembly that can access internals, use the '--multiemit-' option.
input.fsx (1,1)-(47,45) interactive warning Accessing the internal type, method or field 'Price@' from a previous evaluation in F# Interactive is deprecated and may cause subsequent access errors. To enable the legacy generation of a single dynamic assembly that can access internals, use the '--multiemit-' option.
