...
(***hide***)
let positionsSept2017 =
    let p =
        vw.Portfolios
        |> List.find (fun x -> x.Index = 3 && x.FormationMonth = DateTime(2017, 8, 1))
    p.Positions    

let nStocksSept2017 = positionsSept2017.Length
...
(***hide***)
let vwMinSept2017, vwMaxSept2017 =
    let p =
        vw.Portfolios
        |> List.find (fun x -> x.Index = 3 && x.FormationMonth = DateTime(2017, 8, 1))
    p.Positions
...
let ewMinSept2017, ewMaxSept2017 =
    let p =
        ew.Portfolios
        |> List.find (fun x -> x.Index = 3 && x.FormationMonth = DateTime(2017, 8, 1))
    p.Positions
...
(***hide***)
let topWeightsSept2017 =
    positionsSept2017
    |> List.sortByDescending (fun x -> x.Weight)
    |> List.take 10
    |> List.sumBy (fun x -> x.Weight)
