...
input.fsx (1,1)-(2,63) interactive warning Accessing the internal type, method or field 'X@' from a previous evaluation in F# Interactive is deprecated and may cause subsequent access errors. To enable the legacy generation of a single dynamic assembly that can access internals, use the '--multiemit-' option.
input.fsx (1,1)-(2,63) interactive warning Accessing the internal type, method or field 'Y@' from a previous evaluation in F# Interactive is deprecated and may cause subsequent access errors. To enable the legacy generation of a single dynamic assembly that can access internals, use the '--multiemit-' option.
Real: 00:00:00.000, CPU: 00:00:00.000, GC gen0: 0, gen1: 0, gen2: 0
val it: R1 list * int =
  ([{ X = "a"
      Y = 2 }; { X = "b"
