...
```
input.fsx (1,1)-(5,57) interactive warning Accessing the internal type, method or field 'Time@' from a previous evaluation in F# Interactive is deprecated and may cause subsequent access errors. To enable the legacy generation of a single dynamic assembly that can access internals, use the '--multiemit-' option.
input.fsx (1,1)-(5,57) interactive warning Accessing the internal type, method or field 'Return@' from a previous evaluation in F# Interactive is deprecated and may cause subsequent access errors. To enable the legacy generation of a single dynamic assembly that can access internals, use the '--multiemit-' option.
Real: 00:00:00.040, CPU: 00:00:00.046, GC gen0: 1, gen1: 0, gen2: 0
...
```
input.fsx (1,1)-(27,60) interactive warning Accessing the internal type, method or field 'Time@' from a previous evaluation in F# Interactive is deprecated and may cause subsequent access errors. To enable the legacy generation of a single dynamic assembly that can access internals, use the '--multiemit-' option.
input.fsx (1,1)-(27,60) interactive warning Accessing the internal type, method or field 'Return@' from a previous evaluation in F# Interactive is deprecated and may cause subsequent access errors. To enable the legacy generation of a single dynamic assembly that can access internals, use the '--multiemit-' option.
...
```
input.fsx (1,1)-(3,42) interactive warning Accessing the internal type, method or field 'Return@' from a previous evaluation in F# Interactive is deprecated and may cause subsequent access errors. To enable the legacy generation of a single dynamic assembly that can access internals, use the '--multiemit-' option.
...
```
input.fsx (2,1)-(13,32) interactive warning Accessing the internal type, method or field 'Return@' from a previous evaluation in F# Interactive is deprecated and may cause subsequent access errors. To enable the legacy generation of a single dynamic assembly that can access internals, use the '--multiemit-' option.
[Loading C:\Users\runneradmin\AppData\Local\Temp\3116--c8101fe4-dc1c-4738-ae6d-b479b3055840\Project.fsproj.fsx]
Real: 00:00:00.000, CPU: 00:00:00.000, GC gen0: 0, gen1: 0, gen2: 0
namespace FSI_8317.Project

Real: 00:00:00.051, CPU: 00:00:00.046, GC gen0: 0, gen1: 0, gen2: 0
